...
export default function Houston1973() {
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-20 md:px-12 lg:px-20 max-w-4xl mx-auto">
        ...
        <div className="relative w-full max-w-2xl mx-auto mb-10 border-4 border-foreground/80">
          <img 
            src="/1973.jpg" 
            alt="Billie Jean King brandissant son trophée après la Bataille des Sexes en 1973"
        ...
        >
          En 1973, le tennis féminin lutte pour une rémunération égale. Bobby Riggs, ancien numéro 1 mondial connu pour ses déclarations machistes affirmant que le tennis féminin est inférieur, met au défi l&apos;actuelle championne, Billie Jean King. Ce match d&apos;exhibition, surnommé la &quot;Bataille des Sexes&quot;, attire 90 millions de téléspectateurs. Billie Jean King écrase Riggs en trois sets. Cette victoire retentissante devient un catalyseur majeur pour le sport féminin, prouvant la légitimité des athlètes et accélérant la création de la WTA pour défendre l&apos;égalité des gains.
        </p>
