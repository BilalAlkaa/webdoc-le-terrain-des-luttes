...
export default function Johannesburg1995() {
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-20 md:px-12 lg:px-20 max-w-4xl mx-auto">
        ...
        <div className="relative w-full max-w-2xl mx-auto mb-10 border-4 border-foreground/80">
          <img 
            src="/1995.avif" 
            alt="Finale de la Coupe du Monde de rugby 1995 en Afrique du Sud"
        ...
        >
          Un an seulement après la fin officielle de l&apos;apartheid et l&apos;élection de Nelson Mandela, l&apos;Afrique du Sud accueille la Coupe du Monde de rugby. Longtemps perçu comme le sport réservé à la minorité blanche et symbole de l&apos;oppression, le rugby divise. Pourtant, lors de la finale, Nelson Mandela descend sur la pelouse vêtu du maillot vert et or des Springboks pour saluer le capitaine Francois Pienaar. La victoire sud-africaine ce jour-là, portée par la vision de réconciliation de Mandela, transcende le sport pour devenir le symbole d&apos;une nation tentant de panser ses plaies historiques.
        </p>
