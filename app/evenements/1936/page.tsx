...
export default function Berlin1936() {
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-20 md:px-12 lg:px-20 max-w-4xl mx-auto">
        ...
        <div className="relative w-full max-w-2xl mx-auto mb-10 border-4 border-foreground/80">
          <img 
            src="/1936.jpg" 
            alt="Jesse Owens sur le podium aux Jeux Olympiques de Berlin 1936"
        ...
        >
          En plein cœur de l&apos;Allemagne nazie, lors des Jeux Olympiques d&apos;été de 1936, le régime espère utiliser l&apos;événement pour démontrer la suprématie de la prétendue &quot;race aryenne&quot;. C&apos;est sans compter sur Jesse Owens, un athlète afro-américain d&apos;exception. Sous les yeux d&apos;Adolf Hitler et du monde entier, Owens remporte quatre médailles d&apos;or (100m, 200m, saut en longueur et relais 4x100m). Il pulvérise non seulement les records sportifs, mais aussi les théories racistes du régime, transformant l&apos;arène sportive en un formidable symbole de résistance et d&apos;égalité.
        </p>
