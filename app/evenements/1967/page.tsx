...
export default function Boston1967() {
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-20 md:px-12 lg:px-20 max-w-4xl mx-auto">
        ...
        >
          Le dossard 261 qui a changé la course
        </h1>
        ...
        <div className="relative w-full max-w-2xl mx-auto mb-10 border-4 border-foreground/80">
          <img 
            src="/1967.webp" 
            alt="Kathrine Switzer courant le marathon de Boston en 1967 avec le dossard 261"
        ...
        >
          En 1967, le prestigieux marathon de Boston est une épreuve dont les femmes sont officieusement mais fermement exclues, jugées &quot;trop fragiles&quot; pour une telle distance. Bravant cet interdit, Kathrine Switzer s&apos;inscrit sous l&apos;initiale neutre &quot;K.V. Switzer&quot;. En pleine course, Jock Semple, l&apos;un des organisateurs, se rend compte de la supercherie et tente violemment de l&apos;intercepter pour lui arracher son dossard 261. Protégée par son compagnon, elle parvient à fuir l&apos;altercation et à franchir la ligne d&apos;arrivée. Les clichés de l&apos;incident font le tour du monde, forçant l&apos;ouverture des épreuves d&apos;endurance aux athlètes féminines.
        </p>

        {/* Navigation */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t-2 border-foreground/20">
          <Link
            href="/evenements/1948"
