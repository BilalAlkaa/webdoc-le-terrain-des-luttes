...
export default function SanDiego2016() {
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-20 md:px-12 lg:px-20 max-w-4xl mx-auto">
        ...
        >
          Un genou à terre pour la justice
        </h1>
        ...
        <div className="relative w-full max-w-2xl mx-auto mb-10 border-4 border-foreground/80">
          <img 
            src="/2016.jpg" 
            alt="Colin Kaepernick posant un genou à terre pendant l'hymne national en 2016"
        ...
        >
          Lors d&apos;un match de pré-saison de la NFL, le quarterback des 49ers de San Francisco, Colin Kaepernick, choisit de poser un genou à terre pendant l&apos;hymne national américain. Ce geste pacifique et solennel est une protestation directe contre les violences policières et les inégalités raciales frappant la communauté afro-américaine. Le geste déclenche une tempête médiatique et politique sans précédent, divisant l&apos;Amérique. Bien que cela lui ait coûté sa carrière professionnelle, Kaepernick a inspiré un mouvement mondial (&quot;Take a Knee&quot;) qui a largement dépassé les frontières du sport.
        </p>

        {/* Navigation */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t-2 border-foreground/20">
          <Link
            href="/evenements/2012"
          ...
          <span
            className="px-6 py-3 text-sm font-semibold tracking-wide uppercase border-2 border-foreground/30 bg-transparent text-foreground/30 cursor-not-allowed"
            style={{ fontFamily: 'var(--font-playfair)' }}
          >
            Fin de la frise
          </span>
