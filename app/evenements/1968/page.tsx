...
export default function Mexico1968() {
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-20 md:px-12 lg:px-20 max-w-4xl mx-auto">
        ...
        >
          Le poing levé pour les droits civiques
        </h1>
        ...
        <div className="relative w-full max-w-2xl mx-auto mb-10 border-4 border-foreground/80">
          <img 
            src="/1968.avif" 
            alt="Tommie Smith et John Carlos levant le poing aux Jeux Olympiques de Mexico 1968"
        ...
        >
          L&apos;image est l&apos;une des plus emblématiques du 20ème siècle. Lors des Jeux Olympiques de Mexico en 1968, les sprinteurs afro-américains Tommie Smith (médaille d&apos;or) et John Carlos (médaille de bronze) transforment le podium du 200 mètres en une tribune politique mondiale. Sans chaussures pour dénoncer la pauvreté, la tête baissée, ils lèvent chacun un poing ganté de noir au moment où retentit l&apos;hymne national américain. Ce geste pacifique mais d&apos;une puissance inouïe, en soutien au mouvement des droits civiques (&quot;Black Power&quot;), leur vaudra l&apos;exclusion immédiate du village olympique, mais gravera leur courage dans l&apos;histoire.
        </p>
